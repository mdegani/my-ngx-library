...
const LIBRARY_NAME = 'my-ngx-library';
...
gulp.task('build:demo', gulpShell.task(`ng build --prod --aot --base-href https://sumitarora.github.io/${LIBRARY_NAME}/`, { cwd: `${config.demoDir}` }));
